/**
 * Fluent Grow – Modern, lightweight, and accessible design system built with
 * Web Components and advanced CSS features. Zero-runtime, tree-shakeable, and
 * fully typed with strict TS and explicit APIs. Uses Container Queries, Houdini
 * Worklets, View Transitions, and modern CSS. No utility classes. No build step
 * required for consumers. Pure future-CSS today.
 *
 * @see {@link https://fluent.style}
 * @copyright 2025 Veelv. MIT License.
 */

// Core framework exports
export * from './core';

// Layout and positioning primitives
export * from './layout';
